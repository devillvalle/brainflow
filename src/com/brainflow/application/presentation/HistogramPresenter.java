...
public class HistogramPresenter extends ImageViewPresenter {
    ...
    private void updateHistogram() {
        ...
        if (histo == null ) {
            ...
            System.out.println("creating new histogram  with " + nbins + " bins");
            histo = new Histogram(data, nbins);
            histo.ignoreRange(new Range(0, 0));
            System.out.println("putting " + data + " into cache " + " where hashcode " + System.identityHashCode(data));
            cache.put(data, histo);
            System.out.println("cached size : " + cache.size());
            System.out.println("data class : " + data.getClass().getCanonicalName());
        } else {
            System.out.println("retrieved cached histogram");
        }
