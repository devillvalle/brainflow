...
public class HistogramDatasetX extends AbstractDataset implements IntervalXYDataset {
    ...
    public com.brainflow.utils.Range getBinInterval(int item) {
        return new com.brainflow.utils.Range(binIntervals[item], binIntervals[item + 1]);
    }
    
    public com.brainflow.utils.Range getXRange() {
        return new com.brainflow.utils.Range(binIntervals[0], binIntervals[binIntervals.length - 1]);
    }
    
    public com.brainflow.utils.Range getYRange() {
        return new com.brainflow.utils.Range(0, bins[histogram.getHighestBin()]);
    }
