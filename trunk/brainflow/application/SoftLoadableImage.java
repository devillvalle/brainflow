...
public class SoftLoadableImage implements ILoadableImage {
    ...
    public String toString() {
        ...
        /*return new ToStringBuilder(this)
                .append("Header: " + header.getName().getPath())
                .append("Data: " + dataFile.getName().getPath())
                .append("format: " + getFileFormat()).toString(); */
    }

    public int hashCode() {

        return new HashCodeBuilder(17, 37).
                append(header.getName().getPath()).
                append(dataFile.getName().getPath()).
                append(getFileFormat().toString()).
                toHashCode();
    }
