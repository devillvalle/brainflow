...
public class IndexCoordinatePresenter extends AbstractPresenter {
    ...
    private void initBinding() {
        ...
        Bindings.bind(form.getValueLabel1(), ConverterFactory.createStringConverter(imodel, NumberFormat.getIntegerInstance()));
        Bindings.bind(form.getValueLabel2(), ConverterFactory.createStringConverter(jmodel, NumberFormat.getInstance()));
        Bindings.bind(form.getValueLabel3(), ConverterFactory.createStringConverter(kmodel, NumberFormat.getInstance()));
