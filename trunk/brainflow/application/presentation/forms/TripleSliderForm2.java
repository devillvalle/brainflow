 ...
 */
public class TripleSliderForm2 extends JPanel {
    ...
    private void buildGUI() {
        layout = new FormLayout("6dlu, l:125dlu:g, 3dlu, l:max(p;25dlu), 3dlu", "4dlu, p, 3dlu, p, 6dlu, p, 3dlu, p, 6dlu, p, 3dlu, p, 12dlu");
        setLayout(layout);
        ...
        add(valueLabel1, cc.xy(4, 4));
        add(valueLabel2, cc.xy(4, 8));
        add(valueLabel3, cc.xy(4, 12));
    ...
    public static void main(String[] args) {
        ...
        jf.add(new TripleSliderForm2(), BorderLayout.CENTER);
        jf.pack();
        jf.setVisible(true);
    }
