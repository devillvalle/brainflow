...
public abstract class AbstractColorBar extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (getOrientation() == SwingConstants.VERTICAL) {
            at = AffineTransform.getScaleInstance((double) width / 10f, (double) height / colorMap.getMapSize());
        }

        if (getOrientation() == SwingConstants.HORIZONTAL) {
            at = AffineTransform.getScaleInstance((double) width / (double) colorMap.getMapSize(), (double) height / (double) 10);
        }
    ...
    public void drawBackground(Graphics2D g2) {
        ...
        if (backgroundImage == null) {
            ...
            AffineTransform at = AffineTransform.getScaleInstance((double) width / backgroundImage.getWidth(),
