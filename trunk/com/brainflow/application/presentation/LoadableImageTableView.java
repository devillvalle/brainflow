...
import com.brainflow.actions.RemoveLoadableImageAction;
...
public class LoadableImageTableView extends AbstractPresenter implements EventSubscriber {
    ...
    public void onEvent(EventServiceEvent evt) {
        ...
        switch (id) {
            ...
            case IMAGE_REGISTERED:
                ...
                break;
            case IMAGE_REMOVED:
                imageList.remove(event.getLoadableImage());
                imageTableModel.update();
                break;
            case IMAGE_UNLOADED:
                break;
    ...
    private ImageIcon getSnapshot(ILoadableImage limg, int width, int height) {
        ...
        if (icon == null) {
            ...
            dmodel.addLayer(new ImageLayer3D
                    (data, new ImageLayerParameters(ColorTable.GRAYSCALE,
