...
import com.brainflow.application.presentation.IResizeableBorder;
import com.brainflow.application.presentation.ISelectableBorder;
    ...
    private void updateCursorState(CURSOR_STATE state, ImageView cursorView) {
        ...
        switch (state) {
            ...
            case OVER_GRIPPER_SOUTH_EAST:
                ...
                break;
            case ELSEWHERE:
                System.out.println("we're elsewhere ...");
                updateCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
        }

        cursorState = state;
        System.out.println("CURSOR_STATE: " + state);
