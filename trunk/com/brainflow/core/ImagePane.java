...
public class ImagePane extends JComponent {
    ...
    private static Logger log = Logger.getLogger(ImagePane.class.getName());
    ...
    public RenderedImage captureImage() {
        ...
        this.paintComponents(img.createGraphics());
        return img;
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        plotArea = new Rectangle.Double(
                insets.left, insets.top, drawWidth, drawHeight
        );
    ...
    public Dimension getPreferredSize() {
        double w = plot.getXAxisRange().getInterval();
        double h = plot.getYAxisRange().getInterval();
    ...
    public Point translateValueToScreen(Point2D value) {
        Insets insets = getInsets();
        int x = (int) (value.getX() * this.scaleX + insets.left);
        int y = (int) (value.getY() * this.scaleY + insets.top);
