...
import com.brainflow.colormap.RaggedColorMap;
...
public class SnapShooter {
    ...
    public void setDisplayAnatomy(AnatomicalVolume _displayAnatomy) {
        ...
        width = (int) dset.getImageAxis(displayAnatomy.XAXIS).getRange().getInterval();
        height = (int) dset.getImageAxis(displayAnatomy.YAXIS).getRange().getInterval();
    ...
    public static void main(String[] args) {
        try {
            ...
            dset.addLayer(new ImageLayer(il2.getData(), new ImageLayerParameters(ragged)));
