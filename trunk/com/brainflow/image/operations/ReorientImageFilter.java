...
import com.brainflow.image.CoordinateSwap3D;
import com.brainflow.image.IdentitySwap;
...
public class ReorientImageFilter extends com.brainflow.image.operations.AbstractImageFilter {
    ...
    class FlipX implements CoordinateSwap3D {
        IImageData3D src;
        ImageSpace3D space;
        int xdim;
    ...
    class FlipY implements CoordinateSwap3D {
    ...
    class FlipZ implements CoordinateSwap3D {
        IImageData3D src;
        ImageSpace3D space;
        int zdim;
